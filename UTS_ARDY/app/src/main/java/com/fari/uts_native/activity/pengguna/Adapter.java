...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // TODO Edit This Scarlet
        ((TextView) holder.itemCountainer.getChildAt(0)).setText(String.format("Username: %s", data.nama));
        ((TextView) holder.itemCountainer.getChildAt(1)).setText(String.format("Pekerjaan: %s", data.pekerjaan));
    ...
    private void showUpdateModal(Model model) {
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.pekerjaan, pekerjaan.getText().toString())) {
                updatedModel.put("pekerjaan", pekerjaan.getText().toString());
            }
