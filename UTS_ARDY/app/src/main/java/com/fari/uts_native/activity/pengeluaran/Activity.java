...
public class Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleActivity.setText("Pengeluaran");
    ...
    private void showCreateModal() {
        ...
        // TODO Edit This Scarlet
        EditText tanggalKeluar = Utils.createEditText(this, "tanggalKeluar");
        inputContainer.addView(tanggalKeluar);
        EditText jumlah = Utils.createEditText(this, "jumlah");
        inputContainer.addView(jumlah);
        EditText tujuan = Utils.createEditText(this, "tujuan");
        inputContainer.addView(tujuan);
        ...
        createButton.setOnClickListener(v -> {
            Model createdModel = new Model(
                    // TODO Edit This Scarlet
                    tanggalKeluar.getText().toString(),
