...
import id.my.ardy.uts_native.Config;
...
public class Activity extends AppCompatActivity {
    ...
    private void showCreateModal() {
        ...
        // TODO Edit This Scarlet
        EditText title = Utils.createEditText(this, "title");
        inputContainer.addView(title);
        EditText isbn = Utils.createEditText(this, "isbn");
        inputContainer.addView(isbn);
        EditText publicationYear = Utils.createEditText(this, "publicationYear");
        inputContainer.addView(publicationYear);
        EditText genre = Utils.createEditText(this, "genre");
        inputContainer.addView(genre);
        EditText authorId = Utils.createEditText(this, "authorId");
        inputContainer.addView(authorId);
        EditText publisherId = Utils.createEditText(this, "publisherId");
        inputContainer.addView(publisherId);
        EditText categoryId = Utils.createEditText(this, "categoryId");
        inputContainer.addView(categoryId);
        ...
        createButton.setOnClickListener(v -> {
            Model createdModel = new Model(
                    ...
                    publicationYear.getText().toString(),
                    genre.getText().toString(),
                    authorId.getText().toString(),
                    publisherId.getText().toString(),
