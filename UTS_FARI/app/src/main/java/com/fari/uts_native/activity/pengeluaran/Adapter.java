...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // TODO Edit This Scarlet
        ((TextView) holder.itemCountainer.getChildAt(0)).setText(String.format("Tanggal Keluar: %s", data.tanggalKeluar));
        ((TextView) holder.itemCountainer.getChildAt(1)).setText(String.format("Jumlah: %s", data.jumlah));
        ((TextView) holder.itemCountainer.getChildAt(2)).setText(String.format("Tujuan: %s", data.tujuan));
        ((TextView) holder.itemCountainer.getChildAt(3)).setText(String.format("Pengguna ID: %s", data.penggunaId));
    ...
    private void showUpdateModal(Model model) {
        ...
        // TODO Edit This Scarlet
        EditText tanggalKeluar = Utils.createEditText(context, "tanggalKeluar");
        tanggalKeluar.setText(model.tanggalKeluar);
        updateContainer.addView(tanggalKeluar);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.tanggalKeluar, tanggalKeluar.getText().toString())) {
                updatedModel.put("tanggalKeluar", tanggalKeluar.getText().toString());
            }
            ...
            if (!Objects.equals(model.tujuan, tujuan.getText().toString())) {
                updatedModel.put("tujuan", tujuan.getText().toString());
            }
