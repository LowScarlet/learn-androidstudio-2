...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        TextView address = Utils.createTextView(context);
        viewHolder.itemCountainer.addView(address);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ((TextView) holder.itemCountainer.getChildAt(1)).setText(String.format("Address: %s", data.address));
    ...
    private void showUpdateModal(Model model) {
        ...
        EditText address = Utils.createEditText(context, "address");
        address.setText(model.address);
        updateContainer.addView(address);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.address, address.getText().toString())) {
                updatedModel.put("email", address.getText().toString());
            }
