...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        TextView website = Utils.createTextView(context);
        viewHolder.itemCountainer.addView(website);
        TextView maxScore = Utils.createTextView(context);
        viewHolder.itemCountainer.addView(maxScore);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ((TextView) holder.itemCountainer.getChildAt(2)).setText(String.format("Website: %s", data.website));
        ((TextView) holder.itemCountainer.getChildAt(3)).setText(String.format("MaxScore: %s", data.maxScore));
    ...
    private void showUpdateModal(Model model) {
        ...
        EditText website = Utils.createEditText(context, "website");
        website.setText(model.website);
        updateContainer.addView(website);
        EditText maxScore = Utils.createEditText(context, "maxScore");
        maxScore.setText(String.valueOf(model.maxScore));
        updateContainer.addView(maxScore);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.maxScore, Float.valueOf(maxScore.getText().toString()))) {
                updatedModel.put("maxScore", maxScore.getText().toString());
            }
