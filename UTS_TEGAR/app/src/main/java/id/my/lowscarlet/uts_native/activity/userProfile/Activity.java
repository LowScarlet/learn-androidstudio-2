...
public class Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleActivity.setText("UserProfiles");
    ...
    private void showCreateModal() {
        ...
        // TODO Edit This Scarlet
        EditText fullName = Utils.createEditText(this, "fullName");
        inputContainer.addView(fullName);
        EditText bio = Utils.createEditText(this, "bio");
        inputContainer.addView(bio);
        EditText userId = Utils.createEditText(this, "userId");
        inputContainer.addView(userId);
