...
public class Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleActivity.setText("Institutions");
    ...
    private void showCreateModal() {
        ...
        // TODO Edit This Scarlet
        EditText name = Utils.createEditText(this, "name");
        inputContainer.addView(name);
        EditText description = Utils.createEditText(this, "description");
        inputContainer.addView(description);
        EditText website = Utils.createEditText(this, "website");
        inputContainer.addView(website);
        EditText maxScore = Utils.createEditText(this, "maxScore");
        inputContainer.addView(maxScore);
        ...
        createButton.setOnClickListener(v -> {
            Model createdModel = new Model(
                    ...
                    Float.parseFloat(maxScore.getText().toString())
            );
