...
public class Activity extends AppCompatActivity {
    ...
    private void showCreateModal() {
        ...
        // TODO Edit This Scarlet
        EditText username = Utils.createEditText(this, "username");
        inputContainer.addView(username);
        EditText email = Utils.createEditText(this, "email");
        inputContainer.addView(email);
        EditText password = Utils.createEditText(this, "password");
        inputContainer.addView(password);
        EditText role = Utils.createEditText(this, "role");
        inputContainer.addView(role);
        SwitchCompat isActive = Utils.createSwitch(this, "isActive");
        inputContainer.addView(isActive);
