...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        TextView url = Utils.createTextView(context);
        viewHolder.itemCountainer.addView(url);
        TextView isVerified = Utils.createTextView(context);
        viewHolder.itemCountainer.addView(isVerified);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ((TextView) holder.itemCountainer.getChildAt(1)).setText(String.format("Url: %s", data.url));
        ((TextView) holder.itemCountainer.getChildAt(2)).setText(String.format("IsVerified: %s", data.isVerified));
    ...
    private void showUpdateModal(Model model) {
        ...
        EditText url = Utils.createEditText(context, "url");
        url.setText(model.url);
        updateContainer.addView(url);
        SwitchCompat isVerified = Utils.createSwitch(context, "isVerified");
        isVerified.setChecked(model.isVerified);
        updateContainer.addView(isVerified);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (!Objects.equals(model.url, url.getText().toString())) {
                updatedModel.put("url", url.getText().toString());
            }
            if (!Objects.equals(model.isVerified, isVerified.isChecked())) {
                updatedModel.put("isVerified", String.valueOf(isVerified.isChecked()));
            }
